  ...
  return (
    <footer className='mt-24 md:mt-16 py-6 bg-[#131E37] rounded-md text-slate-500 md:grid md:grid-cols-2 font-poppins lg:grid-cols-3'>
        <div>
            ...
            <h3 className=' text-xl  text-center  sm:text-2xl text-slate-400'>Developed by Shipon islam</h3>
            <h3 className='mt-1 text-xl  text-center  sm:text-2xl text-slate-400'> © 2022 All right reserved</h3>
        </div>
        <div className='hidden md:block md:justify-self-center'>
            <h4 className='text-2xl text-slate-400 capitalize border-b border-blue py-1'>navigation</h4>
            <ul>
        ...
        <div className='hidden lg:block md:justify-self-center'>
            <h4 className='text-2xl text-slate-400 capitalize border-b border-blue py-1'>featurre</h4>
            <ul>
               
                <li className='text-xl capitalize pl-1 mt-2 hover:text-blue cursor-pointer'>ui design</li>
                <li className='text-xl capitalize pl-1 mt-2 hover:text-blue cursor-pointer'>fontend dev</li>
                <li className='text-xl capitalize pl-1 mt-2 hover:text-blue cursor-pointer'>backend dev</li>
                <li className='text-xl capitalize pl-1 mt-2 hover:text-blue cursor-pointer'>experience</li>
                <li className='text-xl capitalize pl-1 mt-2 hover:text-blue cursor-pointer'><a className='hover:text-blue' href="./My Resume.pdf" download={true}>download resume</a></li>
            </ul>
        </div>
    </footer>
  )
